...
public enum ExportFileStructureType {
    ...
    GROUPED_RELATIONS_SEPARATE_VIEWS("application-grouped-relations-separate-views","Relations are grouped by type, views  are separated from entites after entites and relations declarations"),
    RELATIONS_BEFORE_VIEWS_SEPARATE_VIEWS("application-entities-relations-views","Relations are after entities and before views, views  are separated from entites after entites and relations declarations");
